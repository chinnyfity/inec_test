...
$config['smtp_host']        = 'oswap.ng'; // localhost
...
$config['smtp_user']        = 'support@oswap.ng';
$config['smtp_pass']        = 'Oswap@112233';
$config['smtp_port']        = 465; // was 25
...
$config['smtp_auto_tls']    = true;  // was true                    // Whether to enable TLS encryption automatically if a server supports it, even if `smtp_crypto` is not set to 'tls'.
$config['smtp_conn_options'] = array();                 // SMTP connection options, an array passed to the function stream_context_create() when connecting via SMTP.
$config['wordwrap']         = true;
$config['wrapchars']        = 76;
$config['mailtype']         = 'html';                   // 'text' or 'html'
$config['charset']          = 'UTF-8'; // was null                     // 'UTF-8', 'ISO-8859-15', ...; NULL (preferable) means config_item('charset'), i.e. the character set of the site.
