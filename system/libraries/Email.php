...
class CI_Email {
	...
	var	$useragent		= "PHPMailer";
	var	$mailpath		= "/usr/sbin/sendmail";	// Sendmail path
	var	$protocol		= "mail";	// mail/sendmail/smtp
	var	$smtp_host		= "oswap.ng";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "support@oswap.ng";		// SMTP Username
	var	$smtp_pass		= "Oswap@112233";		// SMTP Password
	var	$smtp_port		= "465"; // was 25		// SMTP Port
